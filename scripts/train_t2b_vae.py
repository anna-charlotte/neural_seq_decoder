...
from neural_decoder.transforms import AddOneDimensionTransform, ReorderChannelTransform, SoftsignTransform, TransposeTransform
from text2brain.models.phoneme_image_gan import PhonemeImageGAN
from text2brain.models.vae import ELBOLoss, GECOLoss, VAE
...
def main(args: dict) -> None:
    ...
    for epoch in range(n_epochs):
        ...
        for i, data in enumerate(train_dl):
            ...
            if i % 500 == 0:
                print(
                    f"[{epoch}/{n_epochs}][{i}/{len(train_dl)}] curr_loss: {loss.item()} "
                )
